...
CladeIbPlot + ggtitle('Clade Ib = 10X Household SAR') -> p2
CladeIb20Plot + ggtitle('Clade Ib Household SAR = 20%') -> p3
CladeIbExtremePlot + ggtitle('Clade Ib Household SAR = 50%') -> p4
...
library(purr)
library(furrr)
HHSARt = as_tibble(c(0.013,0.13,0.2,0.4,0.5))

plan(multisession, workers = 4)

HHSAR|>
  mutate(tmp = future_map(value, ~CalcRNumbers(HouseholdSAR = .x))) |>
